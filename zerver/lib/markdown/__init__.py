...
class Markdown(markdown.Markdown):
    ...
    def build_preprocessors(self) -> markdown.util.Registry:
        ...
        preprocessors.register(fenced_code.FencedBlockPreprocessor(self), "fenced_code_block", 20)
        preprocessors.register(
    ...
    def build_inlinepatterns(self) -> markdown.util.Registry:
        ...
        reg.register(Timestamp(r"<time:(?P<time>[^>]*?)>"), "timestamp", 166)
        reg.register(
        ...
        reg.register(markdown.inlinepatterns.HtmlInlineProcessor(ENTITY_RE, self), "entity", 80)
        reg.register(
        ...
        reg.register(
            markdown.inlinepatterns.SimpleTextInlineProcessor(NOT_STRONG_RE), "not_strong", 70
        )
